...
contract Handler is Test {
    ...
    function _getUserWithCollateralDeposited(uint256 i) external view returns (address) {
        return usersWithCollateralDeposited[i];
    }

    function _getUserWithCollateralDepositedLength() external view returns (uint256) {
